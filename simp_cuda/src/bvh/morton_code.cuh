...
{
    bool isNegativeX = xyz.x < 0.0f;
    bool isNegativeY = xyz.y < 0.0f;
    bool isNegativeZ = xyz.z < 0.0f;
    ...
    return (isNegativeX ? 0x80000000u : 0) | 
           (isNegativeY ? 0x40000000u : 0) |
           (isNegativeZ ? 0x20000000u : 0) |
           (xx * 4 + yy * 2 + zz);
}
...
{
    bool isNegativeX = xyz.x < 0.0;
    bool isNegativeY = xyz.y < 0.0;
    bool isNegativeZ = xyz.z < 0.0;
